...
class MobileLineItemList extends Component {
...
this.setState({subtotal, calculatedTax, total})
  ...
  render() {
    ...
    return (
      <div>
      <div style={{height: '340px',  overflowY:'auto', overflowX:'hidden'}}>
          ...
          {phases &&
            phases.map((phase, index) => (
              ...
              <div style={{marginBottom:"5px", }}>
                <MobileLineItem phasesLength={phases.length} quote={quote} handleUpdateLineItem={handleUpdateLineItem} handleSelectItem={this.handleSelectItem} selectedItemIndex={selectedItemIndex} phase={phase} index ={index} bidType={bidType}/>
              </div>
            ))
            }
      </div>
      <Grid style ={{marginRight:"10px"}}>
        ...
        <Grid.Column width={4}><Button onClick={()=>this.props.handleLineItemNext(this.state.total)} primary>Next</Button></Grid.Column>
